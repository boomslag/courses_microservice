...
class Video(models.Model):
    ...
    author =                    models.UUIDField(blank=True, null=True)
    course =                    models.ForeignKey('Course', on_delete=models.CASCADE, related_name='courseVideo')
...
class Sellers(models.Model):
    ...
    course =                        models.ForeignKey('Course', on_delete=models.CASCADE, related_name='courseSeller')
...
class Course(models.Model):
    ...
    images =                        models.ManyToManyField(Image,blank=True, related_name='courseImages')
    videos =                        models.ManyToManyField(Video,blank=True, related_name='courseVideos')
...
class Paid(models.Model):
    id = models.BigAutoField(primary_key=True)
    user = models.UUIDField(blank=True, null=True)
    courses = models.ManyToManyField('PaidItem')
    date_created =      models.DateTimeField(auto_now_add=True)
